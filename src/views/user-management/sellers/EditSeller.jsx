...
const EditSeller = () => {
    ...
    try {
      ...
      setFormData({
        ...
        address: {
          ...
          country: sellerData.address?.country || 'Egypt',
        ...
        paymentMethod: sellerData.paymentMethod || 'bank_transfer',
        storeSettings: {
          storeName: sellerData.storeSettings?.storeName || '',
          storeDescription: sellerData.storeSettings?.storeDescription || '',
          storeCategories: sellerData.storeSettings?.storeCategories || [],
        },
        socialMedia: {
          website: sellerData.socialMedia?.website || '',
  ...
  const validateForm = () => {
    ...
    if (existingSellerId && existingSellerId.id !== id) {
  ...
  if (!seller) {
    return (
      <PageContainer title="Edit Seller" description="Edit seller information">
        <Box sx={{ textAlign: 'center', py: 4 }}>
          <LinearProgress sx={{ mb: 2 }} />
          <Typography variant="h6">Loading seller...</Typography>
        </Box>
      </PageContainer>
    );
  }
      ...
      <Box>
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            Modify seller information and details
          </Typography>
        </Box>
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Box>
              ...
              <Stack direction="row" spacing={1} sx={{ mt: 1 }}>
                <Chip label={seller.businessName} size="small" color="primary" variant="outlined" />
                <Chip
                ...
                <Chip
                  label={seller.status}
                  size="small"
                  color={seller.status === 'active' ? 'success' : 'warning'}
                  variant="outlined"
                />
              </Stack>
            </Box>
