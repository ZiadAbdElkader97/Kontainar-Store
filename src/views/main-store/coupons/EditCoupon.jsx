...
import { getCouponById, updateCoupon, generateCouponCode } from '../../../api/coupons/CouponsData.js';
...
const EditCoupon = () => {
  ...
  if (loadingData) {
    return (
      <PageContainer title="Edit Coupon" description="Edit coupon information">
