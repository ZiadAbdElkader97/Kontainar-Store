...
import { getAttributeById, updateAttribute } from '../../../api/attributes/AttributesData.js';
...
const EditAttribute = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateAttribute(id, attributeData);
  ...
  if (loading) {
    return (
      <PageContainer title="Edit Attribute">
        <Box>
          <LinearProgress />
                ...
                <Grid size={{ xs: 12 }}>
                  <Box display="flex" gap={2} justifyContent="flex-end">
                    ...
                    <Button
                      ...
                      disabled={saving}
                    >
                      {saving ? 'Updating...' : 'Update Attribute'}
                    </Button>
                  </Box>
                </Grid>
              </Grid>
